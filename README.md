...
**研究背景：**
<br>
近年注目されるようになった全方位コンテンツですが、その認知度は部分的なものとなっています。原因の1つには、全方位コンテンツを扱うには専門知識が必要となり、一般ユーザが気軽に扱うことができないという問題があると考えられます。そこで私たちの研究グループでは、日常生活の中で当たり前に全方位コンテンツが利用される社会の実現を目指して、臨場感を持ってコンテンツの視聴を可能とする3次元視聴覚ディスプレイシステムと、手軽なコンテンツ制作を可能とする高臨場感コンテンツデザインシステムを開発してきました。
<br> **システム概要：**
...
<br> **ポイント：**
<br>本研究において最も重要となるのが、全方位コンテンツを日常生活の中に浸透させるためにどのようにユーザを動機付け、習慣化させるかという点です。私たちは、「思い出の保存」という用途で全方位コンテンツに触れる機会を増やすことで、全方位コンテンツの認知度の向上を図れると考えました。学習・解析を繰り返し行い、「負担軽減」や「創作意欲の向上」など「思い出の保存」という用途で研究システムを利用してもらうために必要な要素の分析とシステムの開発を実施しています。
<br><br>
***成果：***
...
* このアプリケーションでは、子供が家事の手伝いなど良いことをすることでポイントがたまります。子供は、たまったっポイントを使ってキャラクターを模った仮想的な動くシールを入手することができます。<br><br>
...
# ◆ ハッカソン
**テーマ**
<br>「AIの発展に伴う銀行の新たなあり方」<br>
<br>
**提案したサービス**
<br>「軽融資サービス」<br>
<br>
**概要**
<br>情報化社会の発展に伴いクラウドファンディングなど金融機関が直接関与しないお金の流れが生まれています。これに伴い、個人や団体による小規模事業の立ち上げが活発に行われるようになりました。軽融資サービスは、新たなお金の流れに対応していきたい金融機関と小規模な新規事業を始めたくても踏み出せない一般ユーザを対象とし、金融機関が新規事業を始めたいユーザを支援するための様々なプログラムが盛り込まれたサービスです。<br>
**ポイント**
<br>本サービスの最大の特徴は、金融機関はお金の貸し出しを行わないという点です。信金調達にはクラウドファンディングを利用します。金融機関はお金の貸し出しを行わない代わりに、金融機関がそれまでに培ってきた信頼を貸し出します。クラウドファンディングを用いて資金調達を行う際、金融機関は後見人として事業の信頼性を保証します。社会的に認められている金融機関が仲介を行うことで支援者・被支援者ともに安心して取引を行うことができ、金融機関は社会変化に対応していく土台作りを行うことができます。<br>
**提案システム**
<br>本サービスでは、AIを利用して事業主の審査工程を支援します。具体的には、Microsoft Azure AIサービスChatBotを使用、githubと連携し、githubの情報をスクレイピング・分析を行う機能を実装することで審査工程の簡略化を図ります。<br>
