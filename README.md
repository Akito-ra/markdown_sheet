...
　大学学部生時には、複数のサークルに所属し、多くのコンテンツの開発や展示に携わりました。コンテンツの開発を通して要件定義、設計、開発、テストに至る一連の工程を実際に体験しながら学ぶことができました。<br>
...
**役割：** <br>
本活動では作品制作に取り組むだけでなく、組織運営にも携わりました。組織運営では、「学部3年生で引退するというルールにより、組織体制や風土が浸透しきる前に人が入れ替わってしまい、組織を維持し続けることが難しい。」という課題を解決するため、先輩たちの経験やノウハウを蓄積・浸透させる仕組みの構築と新入生教育体制の見直しを試みました。<br><br>
...
**ポイント**
<br>
本アプリケーションでは、入手したシールを利用してレイアウトを作成することができます。レイアウトの作成や家事の手伝いを通して親子のコミュニケーションの促進することができます。それだけでなく、子供の落書き防止や想像力の発達にもつながると考えられます。<br>
<br><br>
