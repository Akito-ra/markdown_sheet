...
「軽融資サービス」
**概要**
情報化社会の発展に伴いクラウドファンディングなど金融機関が直接関与しないお金の流れが生まれています。これに伴い、個人や団体による小規模事業の立ち上げが活発に行われるようになりました。軽融資サービスは、新たなお金の流れに対応していきたい金融機関と小規模な新規事業を始めたくても踏み出せない一般ユーザを対象とし、金融機関が新規事業を始めたいユーザを支援するための様々なプログラムが盛り込まれたサービスです。
**ポイント**
本サービスの最大の特徴は、金融機関はお金の貸し出しを行わないという点です。信金調達にはクラウドファンディングを利用します。金融機関はお金の貸し出しを行わない代わりに、金融機関がそれまでに培ってきた信頼を貸し出します。クラウドファンディングを用いて資金調達を行う際、金融機関は後見人として事業の信頼性を保証します。社会的に認められている金融機関が仲介を行うことで支援者・被支援者ともに安心して取引を行うことができます。金融機関は仲介料として収入を得ることができるのみでなく、今後の社会変化に対応していくための土台作りを行うこともできます。
**提案システム**
本サービスでは、AIを利用して事業主の審査工程を支援します。具体的には、Microsoft Azure AIサービスChatBotを使用、githubと連携し、githubの情報をスクレイピング・分析を行う機能を実装することで審査工程の簡略化を図ります。
