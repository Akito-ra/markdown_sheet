...
**ポイント**
<br>本サービスの最大の特徴は、金融機関はお金の貸し出しを行わないという点です。信金調達にはクラウドファンディングを利用します。金融機関はお金の貸し出しを行わない代わりに、金融機関がそれまでに培ってきた信頼を貸し出します。クラウドファンディングを用いて資金調達を行う際、金融機関は後見人として事業の信頼性を保証します。社会的に認められている金融機関が仲介を行うことで支援者・被支援者ともに安心して取引を行うことができます。金融機関は仲介料として収入を得ることができるのみでなく、今後の社会変化に対応していくための土台作りを行うこともできます。<br>
**提案システム**
