...
**ポイント**
<br>
本コンテンツでは、没入感の向上と酔いの軽減を目的に、仮想空間内のユーザーの傾きに連動して実際に傾く座椅子の開発を試みました。安全面・コスト面の制約から機械的な実装を断念、台座部分が上下左右前後に自由に伸縮する座椅子を開発し、「ヒトは視線の方向に合わせて無意識に体が傾く」という性質を利用して人の身体動作を誇張することで対処しました。
<br><br><br>
...
**ポイント**
<br>
本アプリケーションでは、入手したシール利用してレイアウトを作成することができます。レイアウトの作成や家事の手伝いを通して親子のコミュニケーションの促進することができます。それだけでなく、子供の落書き防止や想像力の発達にもつながると考えられます。<br>
<br><br>
