...
　大学学部生時には、複数の課外活動団体に所属し、多くのコンテンツの開発や展示に携わりました。また開発だけにとどまらず、プロジェクトマネージャーや新入生勉強会運営責任者などの役割も担当させていただいたき、様々な経験を積むことができました。<br>
　研究では、ヒューマンインタフェース/インタラクション並びにXRに関する研究を実施しています。具体的には、専門意識を持たないユーザーでも手軽にVRコンテンツの制作と共有が行えるWebアプリケーションの開発と「回想法」の支援をはじめとしたVRの新たな用途の開拓に取り組んでいます。
<br><br><br>
...
**活動内容：**<br>
KANAMEプロジェクトは多学科連携・地域活性の理念のもと、クライアントの要望に応じてイベントの目玉となるコンテンツの制作を実施します。<br>
**役割：** <br>
本活動団体では、プログラマー・CGデザイナーとして投影される映像の作成を担当させていただきました。依頼者の方との打合せの際には、エンジニアの立場から企画への助言を行いました。本活動を通して、要件定義から設計、開発、テストに至るまでの一連の工程を体験することができ、加えて実際の現場での施工作業などについても学ぶことができました。

### ■ KIESプロジェクト
<img src="https://github.com/Akito-ra/markdown_sheet/blob/main/img/KIES_img.jpg" width="70%">

**活動内容：**<br>
KIESプロジェクトでは、「VRの可能性を広げる」という理念のもとVRコンテンツの開発を行います。開発したコンテンツはイベントで展示を行い、実際にコンテンツを体験された方々との対話を基に次のプロジェクトテーマを決定します。<br>
**役割：** <br>
本活動では作品制作に取り組むだけでなく、組織運営にも携わりました。組織運営では、「卒業などを理由に人が頻繁に入れ替わってしまうため、安定した組織運営が行えない」という課題を解決することを目的に、ツールの浸透や風土造りに注力しました。<br><br>
...
## ◇ プロジェクションマッピング
### ■ 未来への結び
* 本作品は、「神社の社へ至る参道をきれいに飾ってほしい。」という依頼を受け、制作した来場者参加型のコンテンツです。
...
**ポイント**
<br>
本作品は3DCG技術を用いて制作されておりますが、描画手法を平行投影に切り替えることや輪郭をぼかし影を薄くすることで、映像として出力される際には立体感がなくなるように調整をしました。これによりどの角度から見ても違和感を感じさせないようにしつつ、神秘的な「光の広がり」を表現することに成功しました。
<br><br>
...
**ポイント**
<br>
本コンテンツでは、没入感の向上と酔いの軽減を目的に、仮想空間内のユーザーの傾きに連動して実際に傾く座椅子の開発を試みました。安全面・コスト面の制約から機械的な実装を断念、台座部分が上下左右前後に自由に伸縮する座椅子を開発し、「ヒトは視線の方向に合わせて無意識に体が傾く」という性質を利用して、人の身体動作を誇張することで対処しました。
<br><br><br>
...
**ポイント**
<br>
本アプリケーションでは、入手したシールを利用してレイアウトを作成することができます。レイアウトの作成や家事の手伝いを通して親子のコミュニケーションの促進することができます。シールを張ることと親子の絆を取り戻すという意味を込めて「bonds」という名前を付けました。また本アプリケーションは、子供の落書き防止や想像力の発達にもつながると考えられます。<br>
<br><br>
